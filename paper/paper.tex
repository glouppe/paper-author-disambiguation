...
Soundex \citep{Soundex} phonetic algorithms for mapping author names to their pronunciations.
...
performance reaches  $0.9862$, combining the high recall of NYSIIS blocking
with the better precision of Random Forests.
