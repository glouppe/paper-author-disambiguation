...
title, co-authors or date of publication \glnote{Remove a) and b.}}
\label{fig:signature}
\end{figure}
...
one-versus-all scheme for multi-class classification) for mapping the
...
\textit{Combined best settings.} \glnote{todo}
