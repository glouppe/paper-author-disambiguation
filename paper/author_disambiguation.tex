...
Moreover, we observed that the ethnicity features are an improvement. When these features were not
included in the features set, using the best combined settings, the algorithm yields worse result
($0.9841$).
