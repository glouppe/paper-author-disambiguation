...
\authorrunning{Gilles Louppe et al.}
...
automated machine learning-based methods have been proposed during the past decade to
...
linkage function which tailor our author disambiguation to non-Western author names whenever
necessary.
...
evaluating the degree of belonging of both signatures to an ethnic group. \msnote{Explain here ethnicity features (ethnicities come from some kind of US Census. Name those groups (as I removed them from the table))}
