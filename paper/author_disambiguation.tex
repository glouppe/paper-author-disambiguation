...
this combination exhibits both the high recall of phonetic blocking based on the NYSIIS algorithm and the high precision of Random Forests. Our best combined settings solution achieves relative improvement of more than $76\%$ with respect to the baseline and about $19\%$ with respect to the state-of-the-art choices.
