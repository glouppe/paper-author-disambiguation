...
Overall, these results all encourage further improvements and research. Because of the sensitivity of name-to-ethnicity data, it was not easy to obtain a sufficient coverage of names and ethnicities in the dataset. Even though, we observed some performance enhancements with the generated ethnicity estimator. This motivates working on building a better name-to-ethnicity dataset and measuring its impact on the performance. For
