...
($0.9711$). When pairs are drawn from only from blocks, performance increases
...
\centering
\label{fig:rfe}
\includegraphics[scale=0.5]{figures/rfe.pdf}
\caption{\glnote{todo}}
\end{figure}

Using Recursive Feature Elimination \cite{guyon2002gene} combined
with feature importances \citep{louppe2013understanding} extracted from GBRT,
we next evaluate the usefulness of all 15 standard and 7
additional ethnicity features used together for learning the linkage function.
