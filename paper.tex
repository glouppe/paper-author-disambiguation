...
improvements. In case computational complexity is a concern, this analysis also
underline the fact that decent performance can be achieved using only a very
limited set of features, as also observed in
