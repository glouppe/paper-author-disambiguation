...
\textit{Normalization.} As discussed before, the seemingly anodyne step of
normalizing author names (stripping accents, removing affixes), as done in the
baseline, reveals to be quite significant. Results of Table~\ref{table:results}
