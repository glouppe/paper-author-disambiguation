...
known. Let us also denote by $\widehat{\cal C} = \{ \widehat{c}_i | i = 0, ...,
K-1 \}$ the predicted clusters for all signatures in ${\cal S}$, and by
$\widehat{\overline{\cal C}} = \{ \widehat{c} \cap \bar{{\cal S}} | \widehat{c} \in \widehat{\cal C} \}$ the predicted clusters restricted to signatures for which partial
