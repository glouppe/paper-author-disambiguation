...
\begin{table}
\caption{Maximum recall of blocking strategies.}
\label{table:results}
\centering
\begin{tabular}{|l|c|c|}
  \hline
  \textbf{Blocking} & $R_\text{B3}^*$ & $R_\text{pairwise}^*$ \\
  \hline
  \hline
    SFI & 0.9828 & 0.9776 \\
    Double metaphone & 0.9907 & 0.9863 \\
    NYSIIS & 0.9902 & 0.9861 \\
    Soundex & 0.9906 & 0.9863 \\
  \hline
\end{tabular}
\end{table}
