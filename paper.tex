...
\usepackage{titlesec}
\titleformat{\section}{\sf\large}{\thesection.}{1em}{}
\titleformat{\subsection}{\sf}{\thesubsection}{1em}{}
\titleformat{\subsubsection}{\sf \small}{\thesubsubsection}{1em}{\it }
...
%\icmltitlerunning{Semi-supervised author disambiguation for large and partially annotated databases of scientific publications}
