...
standard 3-fold cross-validation protocol, using ${\cal S}^\prime$ as ground-
truth dataset. To mimic the $|{\cal S}^\prime| / |{\cal S}| \approx 13\%$ ratio
...
whole data ${\cal C}^\prime$, using both B3 and pairwise precision, recall
and F1-measures, as defined below:

\begin{align}
P_\text{B3}({\cal C}, \widehat{\cal C}) &= \\
R_\text{B3}({\cal C}, \widehat{\cal C}) &= \\
F_\text{B3}({\cal C}, \widehat{\cal C}) &= \frac{2 P_\text{B3}({\cal C}, \widehat{\cal C}) R_\text{B3}({\cal C}, \widehat{\cal C})}{P_\text{B3}({\cal C}, \widehat{\cal C}) + P_\text{B3}({\cal C}, \widehat{\cal C})}\\
P_\text{pairwise}({\cal C}, \widehat{\cal C}) &= \\
R_\text{pairwise}({\cal C}, \widehat{\cal C}) &= \\
