...
Gradient Boosted Regression Trees \citep{friedman2001greedy} and Logistic Regression \glnote{add ref} as classifiers.
...
from character $n$, $n+1$, ..., $m$-grams. When not specified, TF-IDF vector
...
build a logistic regression classifier for mapping the $(1,5)$-TF-IDF representation of
